...
class Advanced(QtGui.QWidget):
    def __init__(self,parent):
        ...
        self.check_files=QtGui.QPushButton('Check files' ,parent=self)
        ...
        self.layout.addWidget(self.check_files, 3, 0)
        ...
        self.connect(self.check_files, QtCore.SIGNAL('clicked()'), self.check_files_clicked)
