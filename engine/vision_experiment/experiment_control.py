...
class CaImagingLoop(ServerLoop, CaImagingScreen):
    ...
    def start_imaging(self, parameters):
        ...
        self.imaging_started = self.daq_process.start_daq(ai_sample_rate = parameters['analog_input_sampling_rate'], ao_sample_rate = parameters['analog_output_sampling_rate'], 
