    ...
    def check_experiment_log_for_visual_stimuli(self, experiment_log):        
        if '2.7.' in sys.version:
            reference_strings = [
                ...
                'show_shapes(0.0, [100, 100], [(0, 0)',  
                'show_shapes(0.0, [100, 100, 10], [(0, 0)', 
                'show_shapes(0.0, [100, 100, 10], [(0, 0) ', 
                'show_shapes(0.0333333333333, [200 200 200  20  20  20], [(0, 0) (0, 200) (200, 200) (0, 0) (0, 200) (100, 100)])', 
            ...
            reference_strings = [
                ...
                'show_grating(0.0333333333333, sqr, 40, (0, 0), 0, 0.0, 2400.0, 1.0, 0.5, (0, 0))', 
                'show_shapes(0.0, [100, 100], [array((0, 0),',  
                'show_shapes(0.0, [100, 100, 10], [array((0, 0),', 
                'show_shapes(0.0, [100, 100, 10], [array((0, 0), ', 
                'show_shapes(0.0333333333333, [200 200 200  20  20  20], [(0, 0) (200, 0) (200, 200) (0, 0) (200, 0) (100, 100)])', 
