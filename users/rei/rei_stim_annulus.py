...
class AnnulusPar(experiment.ExperimentConfig):
    def _create_parameters(self):
        self.SIZE = utils.rc((1300,1300))#um, utils.rc((100,10)) (row/y, column/x) or a single number
        self.SHAPE = 'annulus'#annulus, rectangle, spot
        self.POSITION = utils.rc((0, 0))#Center: 0, 0 (vertical, horizontal position)
        self.ON_TIME = 2 #s
        self.OFF_TIME = 10 #s
        self.DELAY_BEFORE_START = 10.0
        self.ANNULUS_THICKNESS = 600
        self.REPETITIONS = 1  
