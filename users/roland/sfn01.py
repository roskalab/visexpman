...
class SFN01BatchConfig(experiment.ExperimentConfig):
    def _create_parameters(self):
        ...
        self.VARS['FullFieldFlashes']['REPETITIONS'] = 1#0
        ...
        self.VARS['Gratings'] = {}   
        self.VARS['Gratings']['REPEATS'] = 1#0
        ...
        self.VARS['Gratings']['VELOCITIES'] = [300, 1600] #[100, 400, 1600]
        ...
        self.VARS['MovingBars']['REPETITIONS'] = 1#0
        ...
        self.VARS['DashStimulus']['REPETITIONS'] = 1#0
