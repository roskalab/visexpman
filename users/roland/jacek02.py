...
# ------------------------------------------------------------------------------
class J02MovingBar(experiment.ExperimentConfig):
...
# ------------------------------------------------------------------------------
class J02WhiteNoise(experiment.ExperimentConfig):
    def _create_parameters(self):
