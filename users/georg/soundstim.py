...
class SoundAndGratingC(experiment.ExperimentConfig):
    def _create_parameters(self):
        ...
        self.BLOCK_DURATION=10.0
        self.FLASH_DURATION=4.0
        self.PAUSE=5.0
        ...
        self.ARDUINO_SOUND_GENERATOR= False #set this from 'not False'
...
class SoundAndGratingE(experiment.Experiment):
    def prepare(self):
        ...
        if self.machine_config.user_interface_name=='stim':
            ...
            if not self.experiment_config.ARDUINO_SOUND_GENERATOR and ec.ENABLE_SOUND:
    ...
    def block(self, speed, condition, orientation):
        ...
        if condition=='sound':
            ...
            self.show_grating(orientation=orientation, 
                               ...
                               mask_size=ec.MASK_SIZE,
                               mask_color=ec.GRAY)
        if ec.ARDUINO_SOUND_GENERATOR and ec.ENABLE_SOUND:
