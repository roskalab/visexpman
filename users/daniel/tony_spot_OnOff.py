...
class SpotExperiment(experiment.Experiment):
    def prepare(self):
        self.fragment_durations = (self.experiment_config.ON_TIME + self.experiment_config.OFF_TIME)*len(self.experiment_config.SPOT_CONTRAST_ON)*self.experiment_config.REPETITIONS_ALL
