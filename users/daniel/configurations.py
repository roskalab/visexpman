...
class AoMicroscopeSetup(VisionExperimentConfig):
    '''
    Visual stimulation machine of 3D microscope setup
    '''
    def _set_user_parameters(self):
...
#        ACQUISITION_TRIGGER_PIN = 1
        ...
        DAQ_CONFIG = [
                    ...
                    'DAQ_TIMEOUT' : 3.0,
                    'SAMPLE_RATE' : 50000,
                    'AI_CHANNEL' : 'Dev1/ai0:3',#ai0: ao trigger, ai1: frame sync, ai2: led control (if present), ai3: ao frame sync,
                    'MAX_VOLTAGE' : 10.0,
                    'MIN_VOLTAGE' : -10.0,
                    'DURATION_OF_AI_READ' : 2*MAXIMUM_RECORDING_DURATION[0],
                    'ENABLE' : True
        ...
        self.MES_RECORD_START_DELAY = 12.0
