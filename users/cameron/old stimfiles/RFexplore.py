...
class ReceptiveFieldExplore(experiment.Experiment):
    ...
    def prepare(self):
        if self.experiment_config.ENABLE_ZOOM:
            ...
            self.positions, display_range = self.calculate_positions(size, center, self.experiment_config.REPEATS, mesh_xy, self.experiment_config.COLORS,self.experiment_config.REPEAT_EACH)
