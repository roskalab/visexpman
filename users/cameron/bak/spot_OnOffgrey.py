...
class SpotOnOffGreyParameters(experiment.ExperimentConfig):
    def _create_parameters(self):
        self.SPOT_SIZE = 4000  # fullfield 2500
        self.ON_TIME = 2 #s
        self.OFF_TIME = 2 #s
        self.BACKGROUND_TIME = 2
        self.SPOT_CONTRAST_ON = [0.625, 0.75, 0.87, 0.999]  #N [0.999]
        ...
        self.runnable = 'SpotOnOffGreyExperiment'        
        self._create_parameters_from_locals(locals())

class SpotOnOffGreyExperiment(experiment.Experiment):
    def run(self):
