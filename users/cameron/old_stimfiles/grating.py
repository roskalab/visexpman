...
class GratParametersCo(experiment.ExperimentConfig):
    def _create_parameters(self):
        self.SPATIAL_FREQUENCY = [0.004, 0.01] #[0.0013, 0.0025, 0.004, 0.01, 0.02] [0.0013,  0.0025,  0.004,  0.01,  0.02,  0.0398,  0.0794,  0.156] 0.01
        # random.shuffle(self.SPATIAL_FREQUENCY)      
        self.TEMPORAL_FREQUENCY = [0.6742,  1.1126] # [0.15,  0.2475,  0.4085,  0.6742,  1.1126,  1.8361,  3.03,  5.0] 0.6742
        ...
        self.GRATING_DURATION = 8.0 #s, presentation of moving grating                           
