...
class IRLaserRandomStimulation(experiment.Experiment):
    ...
    def prepare(self):
        ...
        h.close()
        state_nsamples=self.machine_config.DAQ_CONFIG[1]['SAMPLE_RATE']/self.experiment_config.PRESENTATION_RATE
    ...
    def run(self, fragment_id = 0):
        ...
        daq_instrument.set_waveform(self.machine_config.DAQ_CONFIG[1]['AO_CHANNEL'],self.waveform,sample_rate = self.machine_config.DAQ_CONFIG[1]['SAMPLE_RATE'])
