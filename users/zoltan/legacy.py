...
#        p=PhysTiff2Hdf5('/mnt/rzws/dataslow/rei_data/20150206')
    ...
    def test_04_mesc2visexpa(self):
        ...
        from visexpA.engine.datahandlers.importers import mesc2visexpa
        fp=FileProcessor(mesc2visexpa,'/mnt/datafast/data/20180103/RD1755001', extension='mesc', verbose=True,
                         stim_file_location = '/mnt/datafast/experiment_data/daniel/20180803')
        fp.process()
