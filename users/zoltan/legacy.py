...
#                matfile=['q:\\Rei\\20161103 Gnat2-GCaMP small prep\\20161103_C1#728.phys_LargeSpot_1478183315_0.mat']
        ...
        if len(matfile)>0:
            ...
            supported_stims=['FlashedShapePar','MovingShapeParameters', 'Annulus', 'Spot', 'LargeSpot', 'LargeSpot10sec','Fullfield10min', 'Nostim', 'MovingRectangleParameters', 'SpotOnOff', 'SmallAndLargeSpotParameters']
