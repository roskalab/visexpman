...
#visexp specific
apt-get install python-numpy python-scipy python-zc.lockfile python-sip python-imaging python-tables python-serial python-parallel python-qt4 python-qwt5-qt4 python-opengl python-pygame python-sklearn python wxgtk2.8 python-opencv python-matplotlib python-zmq python-celery python-pp libhdf5-serial-dev
mkdir visexp
cd visexp
