...
class SpotSwitchParameters(experiment.ExperimentConfig):
    def _create_parameters(self):
        ...
        self.SPOT_ON_TIME = 0.5
        self.SPOT_OFF_TIME = 0  #s
        self.SPOT_ON_INTENSITY = [0.5, 0.4, 0.6, 0.3, 0.7, 0.2, 0.8, 0.1, 0.9, 0.01, 0.999] # ON [0.5, 0.4, 0.6, 0.3, 0.7, 0.2, 0.8, 0.1, 0.9, 0.01, 0.999]
        self.REPETITIONS_ALL = 1              
        self.REPETITIONS_ALL_INTENSITY = 3  
