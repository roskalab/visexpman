...
class GratParameters(experiment.ExperimentConfig):
    def _create_parameters(self):
        self.SPATIAL_FREQUENCY = [0.004] #[0.0013,  0.0025,  0.004,  0.01,  0.02,  0.0398,  0.0794,  0.156] 
        # random.shuffle(self.SPATIAL_FREQUENCY)      
        self.TEMPORAL_FREQUENCY = [1.8361] # [0.15,  0.2475,  0.4085,  0.6742,  1.1126,  1.8361,  3.03,  5.0]
        # random.shuffle(self.TEMPORAL_FREQUENCY) 
        self.GRATING_CONTRAST = [0.1] #[0.5,  0.4,  0.6,  0.3,  0.7,  0.2,  0.9,  0.1,  0.9,  0.01, 0.99]
        self.GRATING_MID_CONTRAST = [0.5,  0.4,  0.6,  0.3,  0.7,  0.2,  0.9,  0.1,  0.9,  0.01, 0.99] #[0.5,  0.4,  0.6,  0.3,  0.7,  0.2,  0.9,  0.1,  0.9,  0.01, 0.99]
        ...
        self.GRATING_DURATION = 1.0 #s, presentation of moving grating                           
