...
class TwoPixelFullField(experiment.ExperimentConfig):
    def _create_parameters(self):
        ...
        self.FIXED= [0.5, 0.5, 0.5, 0.5] # fixed contrast on one of the two halves
...
class lisaTwoPixelFullFieldE(experiment.Experiment):
    def prepare(self):
