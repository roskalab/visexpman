#
#+Stims for Tamas:
#+1. Spectrum with till polichrome
#+2. increasing spot: 25, 50, 100, 200, 400, 800, 1600 um, 4 s pause, 2 sec for s
#+3. Single spot: 800 um
#+4. Set parameters from LV interface
#+'
