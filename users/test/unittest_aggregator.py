...
TEST_valid_file = select_path_exists(['/mnt/rzws/codes/visexpman/__init__.py', '/etc/fstab', 'c:\\temp\\dummy.txt', 'r:\\codes\\visexpman\\__init__.py', 'v:\\code\\visexpman\\__init__.py'],dirs=False)
