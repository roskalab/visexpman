...
TEST_unittests = [
    'visexpman.visexp_gui.testVisionExperimentGui',
    'visexpman.vision_experiment.experiment_control.TestCaImaging',
    'visexpman.visexp_app.TestStim',
    'visexpman.vision_experiment.experiment.testExperimentHelpers',
    'visexpman.vision_experiment.experiment_data.TestExperimentData',
    'visexpman.vision_experiment.screen.TestCaImagingScreen',
    'visexpman.vision_experiment.stimulation_library.TestStimulationPatterns',
    'visexpman.TestApplicationInit',
    'visexpman.generic.parameter.testParameter',
    'visexpman.generic.fileop.TestFileops',
    'visexpman.generic.utils.TestUtils',
    'visexpman.generic.log.TestLog',
    'visexpman.generic.signal.TestSignal',
    'visexpman.generic.colors.TestColorUtils',
    'visexpman.generic.videofile.TestVideoFile',
    'visexpman.generic.geometry.TestGeometry',
    'visexpman.hardware_interface.queued_socket.TestQueuedSocket',
    'visexpman.hardware_interface.instrument.TestInstrument',
    'visexpman.hardware_interface.daq_instrument.TestAnalogIOProcess',
    'visexpman.hardware_interface.scanner_control.TestScannerControl',
                ]
