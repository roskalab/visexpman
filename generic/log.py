...
class TestLog(unittest.TestCase):
    def setUp(self):
        ...
        self.machine_config = utils.fetch_classes('visexpman.users.test', 'GUITestConfig', required_ancestors = visexpman.vision_experiment.configuration.VisionExperimentConfig,direct = False)[0][1](clear_files=True)
