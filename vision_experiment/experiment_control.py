...
import visexpman
from visexpman.generic import utils,fileop,introspect,signal
from visexpman.generic.graphics import is_key_pressed,check_keyboard
from visexpman.hardware_interface import mes_interface,daq_instrument,stage_control,digital_io,queued_socket
from visexpman.vision_experiment.screen import CaImagingScreen
try:
    import hdf5io
except ImportError:
    ...
    def execute(self):
        ...
        try:
            ...
            if self.machine_config.PLATFORM in ['standalone',  'intrinsic']:#TODO: this is just a hack. Standalone platform has to be designed
                ...
                from visexpman.vision_experiment.experiment import get_experiment_duration
...
if test_mode:        
    class TestCaImaging(unittest.TestCase):
        ...
        def test_01_ca_imaging_app(self):
            from visexpman.visexp_app import run_ca_imaging
